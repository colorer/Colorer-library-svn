#ifndef _COLORER_FILEERRORHANDLER_H_
#define _COLORER_FILEERRORHANDLER_H_

#include<stdio.h>
#include<common/io/StreamWriter.h>
#include<colorer/handlers/ErrorHandlerWriter.h>

/** File implementation of ErrorHandler.
    Writes all errors into text file. This file includes error
...
public:
  /** Creates FileErrorHandler instance.
      ...
      @param fileName File name to store all errors information.
      @param encoding Output file encoding
      @param clear If true, file would be cleaned before first write.
  */
