...
void FarEditorSet::openMenu()
{
  ...
  try{
    ...
    // т.к. теоритически функци€ getCurrentEditor может вернуть NULL, то будем 
    // провер€ть на это. Ќо ситуаци€ возврата NULL не нормальна, ошибка где то в другом месте
