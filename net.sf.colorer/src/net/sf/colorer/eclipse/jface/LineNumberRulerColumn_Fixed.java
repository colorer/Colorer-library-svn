 ...
 * @since 2.0
 */
public class LineNumberRulerColumn_Fixed implements IVerticalRulerColumn {
     ...
     */
    public LineNumberRulerColumn_Fixed() {
        super();
    }
     ...
     * @since 3.2
     */
    protected boolean isViewerCompletelyShown_fixed() {
    ...
    void doPaint(GC gc, ILineRange visibleLines) {
        fSensitiveToTextChanges= isViewerCompletelyShown_fixed();
        ...
        for (int line= visibleLines.getStartLine(); line < lastLine; line++) {
            ...
            //fCachedTextWidget.getLineHeight(fCachedTextWidget.getOffsetAtLine(widgetLine));
     ...
     * @since 3.0
     */
    protected void postRedraw_fixed() {
        if (fCanvas != null && !fCanvas.isDisposed()) {
